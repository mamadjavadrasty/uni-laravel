        ...
        <div class="w-full sm:max-w-lg rounded shadow text-center bg-white border">
            ...
            <section class="p-4">
                ...
                <form id="form" method="post">
                    ...
                    <div class="mb-4 text-right">
                        <label class="block mb-1 text-gray-500" for="city">نام شهر خود را وارد کنید</label>
                        <input id="city" type="text" name="city" value="" class="py-2 px-3 border focus:border-blue-300 border-gray-300 focus:outline-none rounded-md shadow-sm disabled:bg-gray-100 mt-1 block w-full">
                    </div>
                    <div class="mb-4 text-right">
                    ...
                    <div class="mb-4 text-right">
                        ...
                        <select id="vaccine" name="vaccine" class="py-2 px-3 border focus:border-blue-300 border-gray-300 focus:outline-none rounded-md shadow-sm disabled:bg-gray-100 mt-1 block w-full">
                            <option value="0">واکسن تزریق نکرده ام</option>
        ...
        $.ajax({
            ...
            success:function (response) {
                ...
                if(response.status == 429){
                    message.addClass('hidden');
                    error.removeClass('hidden').html('تعداد درخواست های شما بیش از حد مجاز میباشد');
                }else{
                    var errorHtml = '<ul>'
                    ...
                    errorHtml += '</ul>'
                    message.addClass('hidden');
                    error.removeClass('hidden').html(errorHtml);
                }
                btnSub.html('ثبت');
            }
        })
