        ...
        <div class="rounded shadow text-center bg-white border">
            ...
            <section class="p-4">
                <form id="form" method="get">
                    ...
                    <div class="mb-4 text-right inline-block">
                        <label class="block mb-1 text-gray-500" for="city">شهر</label>
                        <input id="city" type="text" name="city" value="" class="py-2 px-3 border focus:border-blue-300 border-gray-300 focus:outline-none rounded-md shadow-sm disabled:bg-gray-100 mt-1 block">
                    </div>
                    <div class="mb-4 text-right inline-block">
                ...
                <div id="place_table" class="flex justify-center mt-2 border-t">
                    <table class="min-w-full max-h-50 overflow-auto">
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                for(var i = 0;i < results.length;i++){
                    ...
                    htmlString += '<td class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap">'+ result.city  +'</td>';
